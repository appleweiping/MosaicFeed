...
def verify_sdist(path: Path, *, version: str) -> None:
    ...
    required = {
        ...
        f"{expected_root}/docs/mind-submission.md",
        f"{expected_root}/docs/neural-news.md",
        f"{expected_root}/docs/neural-news-selection.md",
        ...
        f"{expected_root}/examples/neural_news_selection_plan.json",
        f"{expected_root}/examples/mind_truth.txt",
        ...
        f"{expected_root}/src/mosaicfeed/neural_news_selection.py",
        f"{expected_root}/src/mosaicfeed/mind_submission.py",
        ...
        f"{expected_root}/tests/test_neural_news_selection.py",
        f"{expected_root}/tests/test_mind_submission.py",
    }
...
def verify_wheel(path: Path, *, version: str) -> None:
    ...
    required = {
        ...
        "mosaicfeed/neural_news_selection.py",
        "mosaicfeed/mind_submission.py",
        "mosaicfeed/py.typed",
